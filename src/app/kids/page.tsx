...
async function getKidsProducts() {
  const res = await fetch(`https://cdn.contentful.com/spaces/${process.env.SPACE_ID}/entries?access_token=${process.env.CONTENTFUL_ACCESS_KEY}&content_type=products&fields.category=Kids`, { cache: 'no-store' });
...
const Kids = async() => {
  ...
  return (
    <Wrapper>
    <h1 className="flex justify-center py-16 max-w-screen mx-auto text-4xl font-bold">All Kids Products</h1>
